      ...
      <div id="pageHolder" className={pageClass}>
        <div id="IDHERE">
          ...
          <div id="pageMenu">
            ...
            <ClickingH
              activate={this.state.menu1}
              trigger={"menu1"}
              handleShow={this.handleMenuShow}
            ></ClickingH>

            <ClickingH
              activate={this.state.menu2}
          ...
          <div id="pHolder">
            ...
            <HidingDiv trigger={this.state.menu1}></HidingDiv>

            <HidingDiv trigger={this.state.menu2}></HidingDiv>

            <HidingDiv trigger={this.state.menu3}></HidingDiv>
          </div>
        </div>
