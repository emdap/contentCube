  ...
  render() {
    ...
    return (
      <div className={"pageHolder " + pageClass}>
        <div id="links">
          ...
          <div className="content">
            <p>
              ...
              •
              <a
                href="https://jsfiddle.net/user/dapodev/fiddles/"
                className="link"
                target="_blank"
              >
                {" "}
              ...
              •
              <a
                hreft="https://chrome.google.com/webstore/search/dapodev"
                className="link"
                target="_blank"
              >
                {" "}
        ...
        <h4>
          <button onClick={() => this.dance()}>Dance!</button>
        </h4>
      </div>
    );
  }
