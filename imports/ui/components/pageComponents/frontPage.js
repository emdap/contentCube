		...
		pageClass = this.props.disp;
			...
			{/* create HidingDiv for each menu, displays content when corresponding ClickingH clicked, trigger corresponds to state */}
			    ...
			    src="/images/face.jpg" />
					...
					<p>I created this website in 2017 when I was still starting out as a software developer. I had never made or deployed a website by myself, so I took some online crash courses in React, and this was the result. If you want to see something more recent I've created, head over to the <a href="https://css-garden.herokuapp.com" className="link">CSS Garden</a>.</p>
